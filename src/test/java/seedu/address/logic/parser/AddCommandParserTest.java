...
import static seedu.address.logic.commands.CommandTestUtil.RECURRING_SCHEDULE_AMY;
import static seedu.address.logic.commands.CommandTestUtil.RECURRING_SCHEDULE_BOB;
...
public class AddCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        ...
        assertParseSuccess(parser, PREAMBLE_WHITESPACE + NAME_DESC_BOB + PHONE_DESC_BOB
                + RECURRING_SCHEDULE_BOB + EMAIL_DESC_BOB
        ...
        assertParseSuccess(parser,
                NAME_DESC_BOB + PHONE_DESC_BOB + RECURRING_SCHEDULE_BOB
    ...
    public void parse_repeatedNonTagValue_failure() {
        String validExpectedPersonString = NAME_DESC_BOB + PHONE_DESC_BOB + RECURRING_SCHEDULE_BOB
                + EMAIL_DESC_BOB + LOCATION_DESC_BOB + TAG_DESC_FRIEND;
    ...
    public void parse_optionalFieldsMissing_success() {
        ...
        assertParseSuccess(parser, NAME_DESC_AMY + PHONE_DESC_AMY + RECURRING_SCHEDULE_AMY
                + EMAIL_DESC_AMY + LOCATION_DESC_AMY, new AddCommand(expectedPerson));
    }
    ...
    public void parse_invalidValue_failure() {
        // invalid name
        assertParseFailure(parser, INVALID_NAME_DESC + PHONE_DESC_BOB + RECURRING_SCHEDULE_BOB
                + EMAIL_DESC_BOB + LOCATION_DESC_BOB
                + TAG_DESC_HUSBAND + TAG_DESC_FRIEND, Name.MESSAGE_CONSTRAINTS);

        // invalid phone
        assertParseFailure(parser, NAME_DESC_BOB + INVALID_PHONE_DESC + RECURRING_SCHEDULE_BOB
                + EMAIL_DESC_BOB + LOCATION_DESC_BOB
        ...
        // invalid email
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + RECURRING_SCHEDULE_BOB
        ...
        assertParseFailure(parser, INVALID_NAME_DESC + PHONE_DESC_BOB + RECURRING_SCHEDULE_BOB
                        + EMAIL_DESC_BOB + INVALID_LOCATION_DESC, Name.MESSAGE_CONSTRAINTS);
